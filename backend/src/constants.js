...
/**
 * @type {{ GOOGLE: "GOOGLE"; GITHUB: "GITHUB"; EMAIL_PASSWORD: "EMAIL_PASSWORD"; PHONE_PASSWORD: "PHONE_PASSWORD"} as const}
 */
...
export const ChatEventEnum = Object.freeze({
  ...
  // ? when a user's presence changes (online/offline)
  PRESENCE_CHANGED_EVENT: "presenceChanged",
  // ? when the complete list of online users is updated
  UPDATE_ONLINE_USERS_EVENT: "updateOnlineUsers",
